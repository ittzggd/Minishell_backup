...
/*   Updated: 2022/07/12 19:17:55 by yukim            ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->pipe_cnt > 0)
		postorder_travel_ast(data, data->ast.prootnode);
	else
		postorder_travel_command(data, data->ast.prootnode);
}
